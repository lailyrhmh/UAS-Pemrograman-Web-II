                        ...
                        <div class="col-md-5">
                            ...
                            <div class="product-images">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <small>{{ $staff->label->label_name}}</small>
                                    <hr>
                                    ...
                                    <div>
                                        <div class="btn-group">
                                            <a href="/talents" class="btn btn-outline btn-primary btn-sm"><i class="fa fa-arrow-left"></i> Back to list talent</a>
                                        </div>
                                    </div>
