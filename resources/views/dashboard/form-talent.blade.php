    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                ...
                <fieldset>
                    <div class="form-group row"><label class="col-sm-2 col-form-label">ID Talent    :</label>
                        <div class="col-sm-10"><input type="text" class="form-control" placeholder="Input Talent ID"></div>
                    </div>
                    <div class="form-group row"><label class="col-sm-2 col-form-label">Talent Name :</label>
                        <div class="col-sm-10"><input type="text" class="form-control" placeholder="Input Talent Name"></div>
                    </div>
                    ...
                    <div class="form-group row"><label class="col-sm-2 col-form-label">Talent Type       :</label>
                        <div class="col-sm-10"><input type="text" class="form-control" placeholder="Group/Solo"></div>
                    </div>
                    <div class="form-group " id="data_1"><label class="font-normal">Debut Date: </label>
